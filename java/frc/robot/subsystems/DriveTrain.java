...
leftBackMotor = new PWMVictorSPX(9);
addChild("Left Back Motor",leftBackMotor);
leftBackMotor.setInverted(true);
        
leftFrontMotor = new PWMVictorSPX(8);
addChild("Left Front Motor",leftFrontMotor);
leftFrontMotor.setInverted(true);
        
rightBackMotor = new PWMVictorSPX(7);
addChild("Right Back Motor",rightBackMotor);
rightBackMotor.setInverted(false);
        
rightFrontMotor = new PWMVictorSPX(6);
addChild("Right Front Motor",rightFrontMotor);
rightFrontMotor.setInverted(false);
        
mecanumDrive1 = new MecanumDrive(leftBackMotor, leftFrontMotor,
rightBackMotor, rightFrontMotor);
addChild("Mecanum Drive 1",mecanumDrive1);
mecanumDrive1.setSafetyEnabled(true);
//mecanumDrive1.setExpiration(0.1);  ------> if the error is still there uncommment this
